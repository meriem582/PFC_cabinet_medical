 ...
 * @author azus
 */
public class ProfilParamètreMAJ extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ProfilParamètreMAJ
     */
    public ProfilParamètreMAJ() {
        initComponents();
       ...
       try {
        ...
        if (ltype.getText().equals("Médecin")) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(tprenom, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 100, 130, -1));
        ...
        getContentPane().add(tnom, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 60, 130, -1));
        ...
        Bsauvgarder.setText("Sauvgarder");
        Bsauvgarder.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BsauvgarderActionPerformed(evt);
            }
        });
        getContentPane().add(Bsauvgarder, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 480, -1, -1));
        ...
        getContentPane().add(bannuler, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 480, -1, -1));
        ...
        getContentPane().add(tspecialite, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 100, 150, -1));
    ...
    private void BsauvgarderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BsauvgarderActionPerformed
        ...
        if (tnom.getText().isEmpty() || tpassword.getText().isEmpty() || tprenom.getText().isEmpty()
            ...
            try {
                ps = c.connexionBdd().prepareStatement("update utilisateurs set type_utilisateur=? , mdp=? ,nom=? ,prénom=? ,privilége=? where nom_utilisateur=? ");

                ps.setString(1, ltype.getText());
                ps.setString(2, tpassword.getText());
                ps.setString(3, tnom.getText());
                ps.setString(4, tprenom.getText());
                ps.setString(5, privilege);
                ps.setString(6, tusername.getText());
    ...
    private void tusernameFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tusernameFocusLost
        boolean tr = false;
        try {
            ps = c.connexionBdd().prepareStatement("select nom_utilisateur from utilisateurs where nom_utilisateur<> ?");
            ps.setString(1, Paramètre.tutilisateur.getValueAt(Paramètre.tutilisateur.getSelectedRow(), 4)+"");
            rs = ps.executeQuery();
            while (rs.next()) {
                if ((tusername.getText().equals(rs.getString("nom_utilisateur")))) {
                    tr = true;
                    break;
                }
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProfilParamètreMAJ.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProfilParamètreMAJ().setVisible(true);
            }
        });
    }
